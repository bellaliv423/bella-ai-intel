...
const TASKS = [
  ...
  ['4 Brothers banner (no slogan)', path.join(PROFILES_DIR, 'leader_profiles_4bros_no_slogan.html'), path.join(PROFILES_DIR, 'leader_profiles_full_clean.png'), {w:1920, h:340}],
  ['Insta post 1080 (no slogan)', path.join(INSTA_DIR, 'insta_post_16_1080_no_slogan.html'), path.join(INSTA_DIR, 'insta_post_16_1080_clean.png'), {w:1080, h:1080}],
  ...
  ['Wallpaper v8 (no slogan)', path.join(WALLPAPERS_DIR, 'v8_final_no_slogan.html'),  path.join(WALLPAPERS_DIR, 'dreamteam_pc_1920x1080_clean.png'), {w:1920, h:1080}],
