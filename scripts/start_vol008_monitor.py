"""Start Upload-Post monitor for VOL.008 KO/EN post"""
import json
import sys
...
@bella_ai_auto VOL.008 「DREAMTEAM」 댓글 감사해요!

오늘 VOL.008 라이브러리 보내드려요 👇
https://bella-nest.vercel.app/journey/vol-008
...
Thanks for your 'DREAMTEAM' comment on @bella_ai_auto VOL.008!
...
if not POST_URL:
    print("Usage: python start_vol008_monitor.py [ko|en] <POST_URL>")
    sys.exit(1)
