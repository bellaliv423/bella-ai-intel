"""Start Upload-Post monitor for VOL.009 KO/EN post"""
import json
import sys
...
@bella_ai_auto VOL.009 「DREAMTEAM」 댓글 감사해요!

오늘 VOL.009 라이브러리 보내드려요 👇
https://bella-nest.vercel.app/journey/vol-009
...
Thanks for your 'DREAMTEAM' comment on @bella_ai_auto VOL.009!
...
if not POST_URL:
    print("Usage: python start_vol009_monitor.py [ko|en] <POST_URL>")
    sys.exit(1)
