"""Start Upload-Post monitor for VOL.010 KO/EN post"""
import json
import sys
...
@bella_ai_auto VOL.010 「DREAMTEAM」 댓글 감사해요!

오늘 VOL.010 라이브러리 보내드려요 👇
https://bella-nest.vercel.app/journey/vol-010

SecondBrain — 옵시디언 + AI 365일 시스템 (토 D+10)
• PARA 4 폴더 (Projects/Areas/Resources/Archive)
• 백링크 [[ ]] + 태그 # = 365일 후 검색 1초
• 드림팀 1만+ 노트 운영 사례
• Claude Code Vault 연동
...
Thanks for your 'DREAMTEAM' comment on @bella_ai_auto VOL.010!

Today's library 👇
https://bella-nest.vercel.app/journey/vol-010

SecondBrain — Obsidian + AI 365-day system (Sat D+10)
- PARA 4 folders (Projects/Areas/Resources/Archive)
- Backlinks [[ ]] + tags # = 1-sec recall after 365 days
- Dream Team's 10K+ notes case
...
if not POST_URL:
    print("Usage: python start_vol010_monitor.py [ko|en] <POST_URL>")
    sys.exit(1)
